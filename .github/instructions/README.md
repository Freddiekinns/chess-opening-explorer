...
- **[markdown.instructions.md](markdown.instructions.md)** - Markdown formatting

## Usage

1. Read relevant instruction files at task start
2. Apply standards and patterns described
3. Update instructions when discovering new patterns (with approval)

## Related

- **[../memory-bank/](../memory-bank/)** - Project context files
