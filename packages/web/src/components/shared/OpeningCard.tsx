    ...
    >
      <div className="card-header" data-testid="card-header">
        ...
        <div className="header-badges">
          {showEco && <span className="eco-badge secondary">{opening.eco}</span>}
        </div>
          ...
          <div className="data-point">
            <div className="game-results-bar">
              <div className="results-label-row">
                <span className="result-label white-label">
                  White {gameStats.white.toFixed(0)}%
                </span>
                <span className="result-label draw-label">Draw {gameStats.draw.toFixed(0)}%</span>
                <span className="result-label black-label">
                  Black {gameStats.black.toFixed(0)}%
                </span>
              </div>
