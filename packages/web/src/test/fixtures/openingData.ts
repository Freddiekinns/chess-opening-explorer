...
export const mockOpeningDataComplete = {
  ...
  analysis_json: {
    description:
      "The King's Pawn Game begins with 1.e4, controlling the center and freeing the bishop and queen. This is one of the most popular and classical opening moves.",
...
export const mockOpeningsList = [
  ...
  mockOpeningDataSimple,
  {
    ...
    analysis_json: {
      description:
        "The Queen's Pawn Game starts with 1.d4, focusing on central control and slower, positional development.",
  ...
  },
  {
    ...
    analysis_json: {
      description:
        'The Réti Opening begins with 1.Nf3, a hypermodern approach that controls the center from afar.',
