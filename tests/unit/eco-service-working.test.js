/**
 * ECO Service Working Tests
 * Tests for the actual ECOService implementation with proper mocking
 */
...
describe('ECOService Working Tests', () => {
  let ecoService;
  ...
  describe('searchOpeningsByName', () => {
    ...
    it('should limit results', () => {
      const limit = 1;
      const result = ecoService.searchOpeningsByName('Defense', limit);
    ...
    it('should handle empty search term', () => {
      const result = ecoService.searchOpeningsByName('');
  ...
  describe('getPopularOpenings', () => {
    ...
    it('should return popular openings', () => {
      const result = ecoService.getPopularOpenings();
    ...
    it('should limit results', () => {
      const limit = 1;
      const result = ecoService.getPopularOpenings(limit);
