...
describe('GET /api/openings/popular-by-eco', () => {
  ...
  const mockOpeningsData = [
    ...
    },
    {
      ...
      fen: 'rnbqkb1r/ppp1pppp/3p1n2/8/2PP4/8/PP2PPPP/RNBQKBNR b KQkq - 0 3',
    ...
    },
    {
      ...
      fen: 'rnbqkb1r/ppp1pppp/3p1n2/4P3/3P4/8/PPP1PPPP/RNBQKBNR b KQkq - 0 3',
      games_analyzed: 18000000,
      src: 'eco_tsv',
    ...
    {
      eco: 'C05',
      name: 'French Defense: Tarrasch Variation, Closed System',
      fen: 'rnbqkb1r/pp3ppp/4pn2/2pp4/3PP3/2P5/PP1N1PPP/R1BQKBNR b KQkq - 0 5',
      games_analyzed: 55000000,
      src: 'eco_tsv',
      moves: '1. e4 e6 2. d4 d5 3. Nd2 Nf6 4. e5 Nfd7 5. c3',
      analysis_json: { complexity: 'Advanced' },
      popularity_score: 4,
      white_win_rate: 0.55,
      black_win_rate: 0.35,
    ...
    },
    {
      eco: 'D02',
      name: 'London System',
      fen: 'rnbqkb1r/pppppppp/5n2/8/3P4/5NP1/PPP1PP1P/RNBQKB1R b KQkq - 0 3',
    ...
    },
    {
      eco: 'D04',
      name: 'Colle System',
      fen: 'rnbqkb1r/ppp1pppp/5n2/3p4/3P4/5N2/PPP1PPPP/RNBQKB1R w KQkq - 0 3',
      games_analyzed: 20000000,
      src: 'eco_tsv',
    ...
    {
      eco: 'D05',
      name: 'Colle System: Traditional',
      fen: 'rnbqkb1r/ppp1pppp/5n2/3p4/3P4/2N2N2/PPP1PPPP/R1BQKB1R b KQkq - 2 3',
      games_analyzed: 18000000,
      src: 'eco_tsv',
      moves: '1. d4 Nf6 2. Nf3 d5 3. Nc3',
      analysis_json: { complexity: 'Intermediate' },
      popularity_score: 4,
      white_win_rate: 0.56,
      black_win_rate: 0.34,
    ...
    },
    {
      ...
      fen: 'rnbqkb1r/ppp2ppp/4pn2/8/2pP4/6P1/PP2PP1P/RNBQKBNR w KQkq - 0 4',
      games_analyzed: 55000000,
      src: 'eco_tsv',
      moves: '1. d4 Nf6 2. c4 e6 3. g3 d5 4. cxd5',
      analysis_json: { complexity: 'Advanced' },
      popularity_score: 6,
      white_win_rate: 0.55,
      black_win_rate: 0.35,
    ...
    {
      eco: 'E04',
      name: 'Catalan Opening: Open Defense, 5.Nf3',
      fen: 'rnbqkb1r/ppp2ppp/4pn2/8/3P4/5NP1/PP2PP1P/RNBQKB1R b KQkq - 1 5',
      games_analyzed: 45000000,
      src: 'eco_tsv',
      moves: '1. d4 Nf6 2. c4 e6 3. g3 d5 4. cxd5 exd5 5. Nf3',
      analysis_json: { complexity: 'Advanced' },
      popularity_score: 5,
      white_win_rate: 0.56,
      black_win_rate: 0.34,
    ...
    },
    {
      ...
      fen: 'rnbqk2r/ppp1bppp/4pn2/8/3P4/5NP1/PP2PPBP/RNBQK2R b KQkq - 3 6',
      games_analyzed: 40000000,
      src: 'eco_tsv',
      moves: '1. d4 Nf6 2. c4 e6 3. g3 d5 4. cxd5 exd5 5. Nf3 Be7 6. Bg2',
      analysis_json: { complexity: 'Advanced' },
      popularity_score: 4,
      white_win_rate: 0.57,
      black_win_rate: 0.33,
  ...
  describe('Performance and functionality tests', () => {
    beforeEach(() => {
      ...
      mockECOService.getPopularOpeningsByECO.mockImplementation((category, limit = 6) => {
        ...
        const mockECOResponse = {
          A: mockOpeningsData
            .filter((o) => o.eco.startsWith('A'))
            .sort((a, b) => b.games_analyzed - a.games_analyzed)
            .slice(0, actualLimit),
          B: mockOpeningsData
            .filter((o) => o.eco.startsWith('B'))
            .sort((a, b) => b.games_analyzed - a.games_analyzed)
            .slice(0, actualLimit),
          C: mockOpeningsData
            .filter((o) => o.eco.startsWith('C'))
            .sort((a, b) => b.games_analyzed - a.games_analyzed)
            .slice(0, actualLimit),
          D: mockOpeningsData
            .filter((o) => o.eco.startsWith('D'))
            .sort((a, b) => b.games_analyzed - a.games_analyzed)
            .slice(0, actualLimit),
          E: mockOpeningsData
            .filter((o) => o.eco.startsWith('E'))
            .sort((a, b) => b.games_analyzed - a.games_analyzed)
            .slice(0, actualLimit),
        };
        ...
        return {
          ...
          metadata: {
            ...
            total_openings_returned: Object.values(mockECOResponse).reduce(
    ...
    test('should sort openings by games_analyzed in descending order within each category', async () => {
      const response = await request(app).get('/api/openings/popular-by-eco').expect(200);
    ...
    test('should handle request with custom limit parameter', async () => {
      const response = await request(app).get('/api/openings/popular-by-eco?limit=3').expect(200);
    ...
    test('should respect maximum limit of 10', async () => {
      const response = await request(app).get('/api/openings/popular-by-eco?limit=20').expect(200);
    ...
    test('should complete request in under 100ms for performance', async () => {
      ...
      await request(app).get('/api/openings/popular-by-eco').expect(200);
  ...
  describe('Error handling', () => {
    ...
    test('should handle ECOService errors gracefully', async () => {
      ...
      const response = await request(app).get('/api/openings/popular-by-eco').expect(500);
