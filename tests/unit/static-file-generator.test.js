...
describe('StaticFileGenerator', () => {
  ...
  describe('static file operations', () => {
    ...
    it('should handle file write errors gracefully', async () => {
      ...
      await expect(generator.writeStaticFile('test_id', {})).rejects.toThrow('Permission denied');
    });
  ...
  describe('cleanup and maintenance', () => {
    it('should clean up orphaned static files', async () => {
      ...
      expect(mockFs.unlink).toHaveBeenCalledWith(expect.stringContaining('opening2.json'));
      expect(mockFs.unlink).toHaveBeenCalledWith(expect.stringContaining('orphaned.json'));
    });
    ...
    it('should generate comprehensive generation report', async () => {
      mockSchema.getOpeningsByEco.mockResolvedValue([{ id: 'opening1' }, { id: 'opening2' }]);
